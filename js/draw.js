...
var main, offset, svg_height, svg_width, _drawCircles, _drawLine;
...
_drawLine = function(nodes, path, SVG, animate) {
  ...
  lineGraph = SVG.append("path").attr("d", lineFunction(path.nodes)).attr("stroke").attr("stroke-width", 5).attr("fill", "none").attr("fill", "none").attr('opacity', '0.6');
  if (animate) {
